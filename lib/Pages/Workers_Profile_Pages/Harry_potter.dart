...
class Harry_Potter extends StatefulWidget {
  const Harry_Potter({super.key});

  @override
  State<Harry_Potter> createState() => _Harry_PotterState();
}

class _Harry_PotterState extends State<Harry_Potter> {
  bool isLiked = false;
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage("Asset/images/Harry_potter.png")),
              ),
              child: Column(
                children: [
                  const Spacer(),
