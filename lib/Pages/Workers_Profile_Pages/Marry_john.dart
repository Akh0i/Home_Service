...
class MarryJohn extends StatefulWidget {
  const MarryJohn({super.key});

  @override
  State<MarryJohn> createState() => MarryJohnState();
}

class MarryJohnState extends State<MarryJohn> {
  bool isLiked = false;
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage("Asset/images/Marry_john.jpg")),
              ),
              child: Column(
                children: [
                  const Spacer(),
