...
class John_Carter extends StatefulWidget {
  const John_Carter({super.key});

  @override
  State<John_Carter> createState() => _John_CarterState();
}

class _John_CarterState extends State<John_Carter> {
  bool isLiked = false;
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage("Asset/images/john_Carter.jpg")),
              ),
              child: Column(
                children: [
                  const Spacer(),
