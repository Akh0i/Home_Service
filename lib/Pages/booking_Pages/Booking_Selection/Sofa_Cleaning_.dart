...
class sofaSelection extends StatefulWidget {
  const sofaSelection({super.key});

  @override
  State<sofaSelection> createState() => sofaSelectionState();
}

class sofaSelectionState extends State<sofaSelection> {
