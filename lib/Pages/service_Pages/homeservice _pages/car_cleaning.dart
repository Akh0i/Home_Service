...
class CarCleaningPage extends StatefulWidget {
  const CarCleaningPage({super.key});

  @override
  State<CarCleaningPage> createState() => CarCleaningPagestate();
}
...
class CarCleaningPagestate extends State<CarCleaningPage> {
  @override
