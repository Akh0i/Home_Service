...
class ElectritionPage extends StatefulWidget {
  const ElectritionPage({super.key});

  @override
  State<ElectritionPage> createState() => ElectritionPagestate();
}
...
class ElectritionPagestate extends State<ElectritionPage> {
  @override
